...
typedef struct SOLUTION_DATA sym_solutions;
...
int sym_get_nsolutions PROTO((sym_environment *env, int *nsolutions));
int sym_get_solution PROTO((sym_environment *env, int index, sym_solutions *solution));
#endif
